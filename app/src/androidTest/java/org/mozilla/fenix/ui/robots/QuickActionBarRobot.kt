...
class QuickActionBarRobot {
    ...
    fun verifyBookmarkSavedSnackBarText() = assertBookmarkSavedSnackBarText()
...
private fun assertEditBookmarkButton() = editBookmarkButton().check(matches(withEffectiveVisibility(Visibility.VISIBLE)))
