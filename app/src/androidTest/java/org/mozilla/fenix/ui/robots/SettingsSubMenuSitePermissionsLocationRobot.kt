...
class SettingsSubMenuSitePermissionsLocationRobot {
    ...
    fun verifyToggleLocationToON() = assertToggleLocationToON()
...
private fun assertNavigationToolBarHeader() =
    onView(CoreMatchers.allOf(withContentDescription("Location")))
...
private fun assertToggleLocationToON() = onView(withText("3. Toggle Location to ON"))
    .check(matches(withEffectiveVisibility(Visibility.VISIBLE)))
