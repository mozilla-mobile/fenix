...
/**
 * Manage references to the [FxaAccountManager]. Retrieves authenticated accounts, FxA profiles,
 * and observes profile state.
 */
open class FenixAccountManager(
    ...
    /**
     * Observes account state and updates homescreen three-dot menu.
     */
