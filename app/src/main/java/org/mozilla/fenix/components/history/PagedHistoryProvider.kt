...
class DefaultPagedHistoryProvider(
    ...
    private lateinit var historyGroups: List<History.Group>
    ...
    private suspend fun getHistoryAndSearchGroups(
        ...
        // Get the history groups that fits within the range of visited times in the current history
        // items.
