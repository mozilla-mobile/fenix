 ...
 *
 * @param interactor [HistoryMetadataInteractor] which will have delegated to all user interactions.
...
class HistoryMetadataViewHolder(
    ...
    fun bind(historyMetadata: HistoryMetadata) {
        ...
        itemView.setOnClickListener {
            interactor.onHistoryMetadataItemClicked(historyMetadata.key.url)
        }
    }
