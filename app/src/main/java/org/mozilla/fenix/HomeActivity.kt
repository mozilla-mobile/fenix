...
import org.mozilla.fenix.perf.StartupTimeline.Method.HOME_ACTIVITY_ON_CREATE
import org.mozilla.fenix.perf.StartupTimeline.Method.HOME_ACTIVITY_ON_RESUME
...
open class HomeActivity : LocaleAwareAppCompatActivity() {
    ...
    final override fun onCreate(savedInstanceState: Bundle?) {
        StartupTimeline.instrumentStart(HOME_ACTIVITY_ON_CREATE)
        ...
        StartupTimeline.instrumentEnd(HOME_ACTIVITY_ON_CREATE)
    }

    @CallSuper
    override fun onResume() {
        StartupTimeline.instrumentStart(HOME_ACTIVITY_ON_RESUME)
        super.onResume()
        ...
        StartupTimeline.instrumentEnd(HOME_ACTIVITY_ON_RESUME)
    }
