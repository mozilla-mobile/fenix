...
class InContentTelemetryTest {
    ...
    fun `track baidu sap metric`() {
        ...
        verify { metrics.track(Event.SearchInContent("baidu.in-content.sap.1000969a")) }
    }
    ...
    fun `track baidu sap-follow-on metric`() {
        ...
        verify { metrics.track(Event.SearchInContent("baidu.in-content.sap-follow-on.1000969a")) }
    }
