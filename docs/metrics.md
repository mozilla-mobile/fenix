...
| collections.total_collections |[counter](https://mozilla.github.io/glean/book/user/metrics/counter.html) |reports the total number of collections user has on startup. If no value is set, we assume total number of collections is 0.  |[1](N/A)||2020-10-01 |
