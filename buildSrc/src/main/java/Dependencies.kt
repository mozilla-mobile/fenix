...
object Versions {
    ...
    const val androidx_datastore_preference = "1.0.0-beta01"
...
object Deps {
    ...
    const val androidx_datastore_preference = "androidx.datastore:datastore-preferences:${Versions.androidx_datastore_preference}"
