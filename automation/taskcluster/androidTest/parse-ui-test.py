...
def main():
    ...
    print("* [Mobile Test Engineering Team Channel on Slack](https://mozilla.slack.com/archives/C02KDDS9QM9)\n")
    print("* [Mobile Test Alerts on Slack](https://mozilla.slack.com/archives/C0134KJ4JHL)\n")
